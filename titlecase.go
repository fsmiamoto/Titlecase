...
import (
	...
	binsearch "github.com/AlasdairF/BinSearch"
...
func init() {
	...
	temp = [][]rune{
		[]rune("à"), []rune("às"), []rune("ao"), []rune("aos"), []rune("da"), []rune("das"), []rune("de"), []rune("des"), []rune("do"), []rune("dos"), []rune("e"), []rune("em"), []rune("na"), []rune("no"), []rune("o"), []rune("para"), []rune("pelo"), []rune("pelos"),
